...
#ifndef TENSORFLOW_LITE_MICRO_FACE_IMAGE_PROVIDER_H_
#define TENSORFLOW_LITE_MICRO_FACE_IMAGE_PROVIDER_H_
...
TfLiteStatus GetFaceImage(tflite::ErrorReporter* error_reporter, int image_width,
                      int image_height, int channels, float* image_data, int type);
